...
public class Product implements Entity {
     ...
     * @param categoryid
     */
    public Product(ObjectId id, String name, String description, double price, String sortimentid, String categoryid, int count) {
        this.id = id;
        this.name = name;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, price, sortimentid, categoryid, count);
    }
